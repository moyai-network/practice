module github.com/moyai-network/practice
...
require (
	...
	github.com/moyai-network/carrot v0.0.0-20230808012116-0ce5ea93eac7
...
require (
	...
	github.com/flonja/multiversion v0.0.0-20230727204349-88d4a8c393a0 // direct
